...
public class MainActivity extends Activity {
    ...
    public static final class AndroidStorageBridge {
        ...
        AndroidStorageBridge(Context context) {
            ...
            dataFile = new File(dataDir, "alo-data.json");
            backupFile = new File(dataDir, "alo-data.json.bak");
            rollbackFile = new File(dataDir, "alo-data.json.rollback");
            tempFile = new File(dataDir, "alo-data.json.tmp");
        }
