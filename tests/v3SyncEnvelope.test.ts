...
const owner: V3SyncOwner = {
  namespace: 'Forge-OS_Base/Domain1127/GoogleChrome/profiles/default',
  profileId: 'default',
};
...
test('V3 envelope rejects namespace mismatch', async () => {
  const envelope = await createV3SyncEnvelope({
    appVersion: '1.0.5',
    deviceId: 'browser',
    owner: { ...owner, namespace: 'Forge-OS_Base/Domain1127/GoogleChrome/profiles/work', profileId: 'work' },
    entities: createEmptyV3SyncEntities(),
    tombstones: [],
    conflicts: [],
    updatedAt: '2026-06-06T00:00:00.000Z',
